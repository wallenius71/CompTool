    ...
    public class WindSpeedComposite:IComposite
    {
                            ...
                            assignvalue:
                                {
                                    ...
                                    switch(UseColumn )
                                    {
                                        ...
                                        case SelectValue.both:
                                            double averageWs= new double[2] { AVal, BVal }.Average();
        ...
        private void CheckDeadRange(IWindSpeedConfig A, IWindSpeedConfig B)
        {
            ...
            Console.WriteLine(" dist from a to b " + distanceAB + " B to A " + distanceBA);
                //use the smallest sector. The boundaries that are manipulated if we need to extend the range depend on 
                //the orientation of A and B to eachother
